            ...
            <li class="nav-item">
                <div class="sidebar-sticky pt-3">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('mailer-list.index')}}">
                                ...
                                Подключения почтового ящика для рассылки
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <a class="nav-link dropdown-toggle " href="{{route('user.logout')}}" data-toggle="modal"
